...
class TripCrew:
    ...
    def run(self):
        try:
            ...
            # Extract string from CrewOutput object (newer CrewAI versions)
            ...
            self.output_placeholder.markdown(result_text)
            return result_text
...
if __name__ == "__main__":
        ...
        st.sidebar.markdown(
            ...
            <a href="https://github.com/joaomdmoura/crewAI" target="_blank">
                <img src="https://raw.githubusercontent.com/joaomdmoura/crewAI/main/docs/crewai_logo.png"
                     alt="CrewAI Logo" style="width:100px;"/>
            </a>
            """,
            unsafe_allow_html=True
        )
    ...
    if submitted:
        ...
        if result:
            ...
            st.error("No trip plan was generated. Please check your API key and try again.")